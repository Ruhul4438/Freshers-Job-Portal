...
function CompaniesCard({companies}) {
  ...
  <div className="flex justify-between items-center p-2">
    ...
    <div className="flex flex-col md:flex-row flex-grow justify-between items-start pl-5 gap-3 md:gap-0 border border-green-500">
      ...
      <div className="flex-shrink-0 border border-pink-500 md:mr-16 lg:mr-62 xl:mr-40 2xl:mr-60  ">
