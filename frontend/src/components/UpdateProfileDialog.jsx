        ...
        >
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="flex flex-col items-center   border border-red-500">
              ...
              {uploadProgress > 0 && (
                <div className="flex flex-col items-center gap-1 border border-yellow-600">
...
//         <Dialog open={open} onOpenChange={setOpen} >
//                 <DialogContent className=" sm:max-w-[425px] md:max-w-[600px] max-w-[90%] p-5"   onInteractOutside={() => setOpen(false)} >
//                     <DialogHeader >
//                         <DialogTitle>Update Profile</DialogTitle>
//                     </DialogHeader>
//                     <form onSubmit={submitHandler}>
